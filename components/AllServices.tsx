...
export default function AllServices() {
  ...
  const Oracle = `https://cdn.simpleicons.org/oracle/${imageColor}`;
      ...
      <div className='bg-background text-foreground pb-12'>
        ...
        <div className='flex justify-center items-center mx-4'>
          <div className='text-center h-full w-full grid grid-cols-2 md:grid-cols-4 gap-10 '>
            ...
            <div className='flex flex-col justify-center items-center'>
              <Image alt="wordpress" src={Oracle} height={150} width={150} className='h-full w-20 mb-3' />
              <p className='h-1/2'>We provide a comprehensive set of solutions for all your WordPress needs, specializing in a variety of industries applications.</p>
            </div>
            ...
            <div className='flex flex-col justify-center items-center'>
              <Image alt="styled-components" src={Ibm} height={150} width={150} className='h-full w-20 mb-3' />

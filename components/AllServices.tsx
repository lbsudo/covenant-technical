      ...
      <div className='bg-white text-black pb-12'>
        ...
        <div className='flex justify-center items-center'>
          <div className='text-center h-full w-full grid grid-cols-2 md:grid-cols-4 gap-10 '>
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="wordpress" src="https://cdn.simpleicons.org/Kalilinux/black" className='h-1/2 w-20 mb-3' />
              <p className='h-1/2'>We provide a comprehensive set of solutions for all your WordPress needs, specializing in a variety of industries applications.</p>
            </div>

            <div className='flex flex-col justify-center items-center'>
              <img alt="wordpress" src="https://cdn.simpleicons.org/oracle/black" className='h-1/2 w-20 mb-3' />
              <p className='h-1/2'>We provide a comprehensive set of solutions for all your WordPress needs, specializing in a variety of industries applications.</p>
            </div>

            <div className='flex flex-col justify-center items-center'>
              <img alt="wordpress" src="https://cdn.simpleicons.org/Wordpress/black" className='h-1/2 w-20 mb-3' />
              <p className='h-1/2'>We provide a comprehensive set of solutions for all your WordPress needs, specializing in a variety of industries applications.</p>
            </div>
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/drupal/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/magento/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/sitecore/black" className='h-1/2 w-20 mb-3' />
              <p className='h-1/2'>We offer ﬁrst-class expertise, enabling customers to get the most out of Sitecores capabilities.</p>
            </div>
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/squarespace/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/bigcommerce/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/shopify/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/contentful/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/hubspot/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="wordpress" src="https://cdn.simpleicons.org/adobe/black" className='h-1/2 w-20 mb-3' />
              <p className='h-1/2'>We provide a comprehensive set of solutions for all your WordPress needs, specializing in a variety of industries applications.</p>
            </div>
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/microsoft/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/ibm/black" className='h-1/2 w-20 mb-3' />
            ...
            <div className='flex flex-col justify-center items-center'>
              <img alt="styled-components" src="https://cdn.simpleicons.org/linux/black" className='h-1/2 w-20 mb-3' />

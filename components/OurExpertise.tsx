    ...
    <>
      <motion.div className='text-foreground w-full'
        ...
        <div className='flex flex-col text-white w-full md:flex-row text-xl '>
          <div className='relative w-full h-screen md:w-1/4 md:h-11/12'>
            <Image src='/analyze.jpg' alt='analyze' layout='fill' objectFit='cover' priority />
          ...
          <div className='relative w-full h-screen md:w-1/4 md:h-11/12' >
            <Image src='/stratagize.jpg' alt='analyze' layout='fill' objectFit='cover' priority />
            <div className='relative w-full pl-3 mt-96'>
          ...
          <div className='relative w-full h-screen md:w-1/4 md:h-11/12'>
            <Image src='/develop.jpg' alt='analyze' layout='fill' objectFit='cover' priority />
            <div className='relative w-full pl-3 mt-96'>
          ...
          <div className='relative w-full h-screen md:w-1/4 md:h-11/12'>
            <Image src='/deply.jpg' alt='analyze' layout='fill' objectFit='cover' priority />
            <div className='relative w-full pl-3 mt-96'>
